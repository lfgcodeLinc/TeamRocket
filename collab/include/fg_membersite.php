 ...
 /**       
    ...
    **/    
    ...
    function GetUserFromEmail($email,&$user_rec)
    {
        ...
        $result = mysqli_query($this->connection, "Select * from $this->tablename where username='$email'");  
    ...
    function ValidateRegistrationSubmission()
    {
        ...
        $validator->addValidation("username","email","The input for username should be a valid email value");
    ...
    function SendAdminIntimationEmail(&$formvars)
    {
        ...
        $mailer->Body ="A new user registered at ".$this->sitename."\r\n".
        "Name: ".$formvars['name']."\r\n".
        "Email address: ".$formvars['username']."\r\n".
