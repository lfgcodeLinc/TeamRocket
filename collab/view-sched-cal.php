...
$start_year=2014; // Starting year for dropdown list box
...
self.location='view-sched-cal.php?month=' + month_val + '&year=' + year_val ; // reload the page
}
</script>
<style type="text/css">
table.main {
...
$pv="'$month'".","."'$i'".","."'$year'";
echo $adj."<td><a href='schedule-event.php?month=$month&day=$i&year=$year' onclick=\"post_value($pv);\">$i</a>"; // This will display the date inside the calendar cell
echo " </td>";
$adj='';
$j ++;
...
echo "</tr></table>";
echo "<center><a href=view-sched-cal.php>Reset PHP Calendar</a></center>";
